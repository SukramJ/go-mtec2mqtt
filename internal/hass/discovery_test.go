...
// The entity_id seeds must stay English even when LANGUAGE selects a
// translated friendly name — only "name" is localised.
func TestEntityIDSeedsStayEnglishUnderTranslation(t *testing.T) {
